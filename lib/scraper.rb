...
class Scraper
  ...
  def self.scrape_profile_page(profile_url)
    ...
    student[:bio] = website.css("div.bio-content.content-holder div.description-holder p").text if webiste.css("div.bio-content.content-holder div.description-holder p")
